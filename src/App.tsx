              ...
              <Routes location={location} key={location.pathname}>
                ...
                <Route path="*" element={
                  <div className="flex flex-col items-center justify-center py-32 px-4 text-center w-full max-w-2xl mx-auto font-sans grow">
                    ...
                    <h1 className="text-4xl font-black text-neutral-800 tracking-tight uppercase">404: Page Not Found</h1>
                    <p className="mt-4 text-neutral-500 text-base leading-relaxed">
                      We couldn't find the page or post you were looking for. It might have been removed, renamed, or temporarily offline.
                    </p>
                    <button onClick={() => navigate('/')} className="mt-8 px-8 py-3 bg-red-800 text-white font-bold tracking-widest text-sm uppercase cursor-pointer border-2 border-transparent transition-all hover:bg-red-900 shadow-[4px_4px_0_0_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none">
                      Go Back Home
                    </button>
                  </div>
                } />
